...
public class SelectionBuilder {
     ...
     * surrounded with parenthesis and combined using {@code AND}.
     */
    public SelectionBuilder whereLike(String selection, String selectionArgs) {
        if (TextUtils.isEmpty(selection)) {
            if (selectionArgs != null) {
                throw new IllegalArgumentException(
                        "Valid selection required when including arguments=");
        ...
        mSelection.append("(").append(selection).append(" LIKE '%").append(selectionArgs).append(
                "%')");
        return this;
    }
     ...
     * surrounded with parenthesis and combined using {@code AND}.
     */
    public SelectionBuilder whereIn(String selection, List<String> selectionInArgs) {
        if (TextUtils.isEmpty(selection)) {
            if (selectionInArgs != null && selectionInArgs.size() > 0) {
                throw new IllegalArgumentException(
                        "Valid selection required when including arguments=");
            }
        ...
        String inClauseStr = " IN (" + StringUtils.toString(selectionInArgs) + ")";
        mSelection.append("(").append(selection).append(inClauseStr).append(")");
        return this;
    }
